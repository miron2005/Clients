...
# --- Backend: DTO ---
cat > backend/src/bookings/dto/admin-create-booking.dto.ts <<'FILE'
...
# --- Backend: Controller ---
cat > backend/src/bookings/admin-bookings.controller.ts <<'FILE'
...
# --- Backend: Service (полная замена, чтобы не городить патчи) ---
...
# --- Frontend: Calendar page (добавляем модалку создания + dblclick по сетке) ---
